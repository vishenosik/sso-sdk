...
const file_authentication_proto_rawDesc = "" +
	"\n" +
	"\x14authentication.proto\x12\x11authentication.v1\"C\n" +
	...
	"\bis_admin\x18\x01 \x01(\bR\aisAdmin2\x83\x02\n" +
	"\x0eAuthentication\x12S\n" +
	"\bRegister\x12\".authentication.v1.RegisterRequest\x1a#.authentication.v1.RegisterResponse\x12J\n" +
	"\x05Login\x12\x1f.authentication.v1.LoginRequest\x1a .authentication.v1.LoginResponse\x12P\n" +
	"\aIsAdmin\x12!.authentication.v1.IsAdminRequest\x1a\".authentication.v1.IsAdminResponseB2Z0github.com/blacksmith-vish/sso;authentication_v1b\x06proto3"
...
var file_authentication_proto_depIdxs = []int32{
	...
	1, // 3: authentication.v1.Authentication.Register:output_type -> authentication.v1.RegisterResponse
	3, // 4: authentication.v1.Authentication.Login:output_type -> authentication.v1.LoginResponse
	5, // 5: authentication.v1.Authentication.IsAdmin:output_type -> authentication.v1.IsAdminResponse
